...
class fmi3InstantiateModelExchange(BaseFMI3Module):
    def __init__(self):
        template = """    fmi3Instance fmi3InstantiateModelExchange(  fmi3String                 instanceName,
...
if __name__ == "__main__":
    """Test the generator"""
    generator = fmi3InstantiateModelExchange()
